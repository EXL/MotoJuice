...
function twentyfourteen_scripts() {
	...
	wp_enqueue_style( 'twentyfourteen-style', get_template_directory_uri() . '/style.css', array(), '20182403' );
	...
	wp_enqueue_script( 'twentyfourteen-script', get_template_directory_uri() . '/js/functions.js', array( 'jquery' ), '20191107', true );
}
