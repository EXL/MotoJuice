 ...
 */
function comment_form_aux( $args = array(), $post_id = null ) {
	if ( null === $post_id )
		$post_id = get_the_ID();
	...
	$fields   =  array(
		...
		'cookies' => '<p class="comment-form-cookies-consent"><input id="wp-comment-cookies-consent" name="wp-comment-cookies-consent" type="checkbox" value="yes"' . $consent . ' />' .
					 '<label for="wp-comment-cookies-consent" style="display: inline;margin-left: 5px;">' . __( 'Save my name, email, and website in this browser for the next time I comment.' ) . '</label></p>',
	);
